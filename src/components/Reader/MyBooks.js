...
export default class MyBooks extends React.Component {
    ...
    componentDidMount() {
        let arr = [require("../../resource/book/thumbnail/book-4.jpg"), require("../../resource/book/thumbnail/book-2.jpg"), require("../../resource/book/thumbnail/book-3.jpg")];
