...
class AuthorSettings extends Component {
    ...
    doUpdate() {
        this.setState({
                ...
                if (this.validateForm()) {
                    ...
                    AuthorService.updateAccountDetails(
    ...
    validateForm() {
        ...
        if (!ValidationService.phoneNoIsValid(this.state.phoneNumber)) { // phone number validation
    ...
    getAccountDetails(flag) {
        ...
        AuthorService.getAccountDetails(this.props.params.uid)
            .then((response) => {
                if (response.status === 200) {
                    response.json()
    ...
    doDelete = () => {
        AuthorService.deleteAccount(this.props.params.uid)
            .then((response) => {
                if (response.status === 200) {
                    localStorage.clear(); 
                    this.props.navigate("/", {
